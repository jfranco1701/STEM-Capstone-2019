...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.login = function (user) {
        var _this = this;
        this.http.post('/api/token/auth', '{"data":{"type": "ObtainJSONWebToken","attributes": {"username": "'+ user.username +'","password":"'+ user.password+'"}}}',  this.httpOptions).subscribe(function (data) {
